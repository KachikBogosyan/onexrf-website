...
export default async function MaterialPage({
  ...
  // Use bidirectional lookup to find all applications that use this material
            ...
            <div className="grid md:grid-cols-2 gap-4">
              {applications.map((app) => (
                <Link
                  ...
                  className="bg-white p-5 rounded-lg shadow-sm border-l-4 border-blue-500 hover:shadow-md transition-shadow block"
                >
      ...
      {relatedProducts.length > 0 && (
        <section id="related" className="py-16 px-4 sm:px-6 lg:px-8 bg-gray-50 scroll-mt-20">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-3xl font-bold text-gray-900 mb-8">Products for Processing This Material</h2>
